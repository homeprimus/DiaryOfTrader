...
namespace DiaryOfTrader.EditDialogs.Dictionary
{
  partial class TrendDlg
  {
    ...
    {
      var resources = new System.ComponentModel.ComponentResourceManager(typeof(TrendDlg));
      ...
      IconOptions.Icon = (Icon)resources.GetObject("TrendDlg.IconOptions.Icon");
      Name = "TrendDlg";
